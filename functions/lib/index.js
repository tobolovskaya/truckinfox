...
exports.healthCheck = exports.placeDetails = exports.placesAutocomplete = exports.retryFailedNotifications = exports.sendBatchNotificationsOnNewRequest = exports.cleanupTypingIndicators = exports.scheduledNotifications = exports.refundVippsPayment = exports.processVippsPayment = exports.verifyCarrier = exports.onBidAccepted = exports.onNewBid = void 0;
...
async function withRetry(fn, retries = 3, delayMs = 1000) {
    ...
    for (let attempt = 0; attempt <= retries; attempt++) {
        try {
            ...
            // Log retry attempt
            console.log(`🔄 Retry attempt ${attempt + 1}/${retries} after ${delay}ms. Error: ${lastError.message}`);
...
exports.refundVippsPayment = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const refundResponse = await withRetry(() => axios_1.default.post(`https://api.vipps.no/ecomm/v2/payments/${orderId}/refund`, {
...
exports.sendBatchNotificationsOnNewRequest = functions.firestore
    ...
    try {
        ...
        for (const doc of carriersQuery.docs) {
            ...
            if (((_a = carrier.notification_preferences) === null || _a === void 0 ? void 0 : _a.cargo_requests) === false) {
                filtered++;
                continue;
            }
        ...
        for (let batchIndex = 0; batchIndex < batches.length; batchIndex++) {
            ...
            try {
                ...
                console.log(`✅ Batch ${batchIndex + 1}/${batches.length}: ${response.successCount} sent, ${response.failureCount} failed`);
                ...
                console.error(`❌ Error sending batch ${batchIndex + 1}/${batches.length}:`, error instanceof Error ? error.message : error);
        ...
        console.log(`✅ Batch notification completed for request ${requestId}:`, `${totalSent}/${carrierTokens.length} delivered (${((totalSent / carrierTokens.length) * 100).toFixed(1)}%)`);
    }
    catch (error) {
...
exports.retryFailedNotifications = functions.pubsub
    ...
    try {
        ...
        for (const doc of failedLogs.docs) {
            ...
            const failedCarriers = await withRetry(async () => {
                return await admin
                    ...
                    .collection('users')
                    .where('user_type', '==', 'carrier')
                    .where('service_areas', 'array-contains', request === null || request === void 0 ? void 0 : request.from_city)
                    .where('is_active', '==', true)
                    .get();
            }, 2);
                ...
                try {
                    const response = await admin.messaging().sendEachForMulticast({
                        ...
                        notification: {
                            ...
                            body: `${request === null || request === void 0 ? void 0 : request.cargo_type} from ${request === null || request === void 0 ? void 0 : request.from_address}`,
                        },
                        data: {
                    ...
                    console.log(`✅ Retry for request ${requestId}: ${response.successCount}/${tokens.length} successful`);
                }
                catch (error) {
        ...
        console.log(`✅ Retry completed: ${totalSuccessful}/${totalRetried} successful (${((totalSuccessful / totalRetried) * 100).toFixed(1)}%)`);
        return null;
    }
    catch (error) {
...
Object.defineProperty(exports, "placesAutocomplete", { enumerable: true, get: function () { return placesProxyExample_1.placesAutocomplete; } });
Object.defineProperty(exports, "placeDetails", { enumerable: true, get: function () { return placesProxyExample_1.placeDetails; } });
Object.defineProperty(exports, "healthCheck", { enumerable: true, get: function () { return placesProxyExample_1.healthCheck; } });
