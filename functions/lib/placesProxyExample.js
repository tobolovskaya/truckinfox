...
const checkRateLimit = async userId => {
  ...
  const requests = ((data === null || data === void 0 ? void 0 : data.requests) || []).filter(
    t => t > oneHourAgo
  );
...
exports.placesAutocomplete = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    const response = await withRetry(() =>
      axios_1.default.get('https://maps.googleapis.com/maps/api/place/autocomplete/json', {
        params: {
          input,
...
exports.placeDetails = functions.https.onCall(async (data, context) => {
  try {
    ...
    const response = await withRetry(() =>
      axios_1.default.get('https://maps.googleapis.com/maps/api/place/details/json', {
        params: {
