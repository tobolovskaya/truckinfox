...
function generateCargoSearchTerms(data) {
  var _a, _b, _c;
  const terms = new Set();
  generateSearchTerms((_a = data.title) !== null && _a !== void 0 ? _a : '').forEach(term =>
    terms.add(term)
  );
  generateSearchTerms((_b = data.from_address) !== null && _b !== void 0 ? _b : '').forEach(term =>
    terms.add(term)
  );
  generateSearchTerms((_c = data.to_address) !== null && _c !== void 0 ? _c : '').forEach(term =>
    terms.add(term)
  );
  if (data.cargo_type) {
