  ...
  try {
    ...
    if (transition === 'paid->in_progress') {
      notification = {
        ...
        title: 'notifOrderUpdateTitle',
        body: 'notifCarrierStartedBody',
      ...
      notification = {
        ...
        type: 'order_status_change',
        title: 'notifOrderUpdateTitle',
        body: 'notifDeliveryConfirmedBody',
