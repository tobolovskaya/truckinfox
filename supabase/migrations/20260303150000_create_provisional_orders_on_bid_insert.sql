-- Create provisional orders for pending bids so both customer and carrier see them in Orders.
...
DROP TRIGGER IF EXISTS trg_create_provisional_order_on_bid_insert ON public.bids;
CREATE TRIGGER trg_create_provisional_order_on_bid_insert
AFTER INSERT ON public.bids
FOR EACH ROW
EXECUTE FUNCTION public.create_provisional_order_on_bid_insert();
